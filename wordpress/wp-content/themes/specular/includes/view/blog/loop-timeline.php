	...
	while (have_posts()) : the_post();
        ...
        <article id="post-<?php echo the_ID(); ?>" <?php echo post_class('row-fluid blog-article timeline-style normal'); ?>>                    
	     ...
	     ?>
             ...
             <div class="post_box <?php if(codeless_get_mod('timeline_box_shadow')) echo 'box_shadow'; ?>">
                ...
                <div class="media">
                    ...
                    <?php if($post_format == 'audio'){
                        ...
                        <img src="<?php echo esc_url(codeless_image_by_id(get_post_thumbnail_id(), 'blog', 'url')) ?>" alt="<?php echo esc_attr__('Featured Image', 'specular') ?>">
                    ...
                    <?php if($post_format == 'quote'){ ?>
                        ...
                        <ul class="info">
                            ...
                            <?php if(!empty($tag_out) ): ?>
                                    <li><i class="linecon-icon-tag"></i><?php echo esc_attr($tag_out) ?></li>
                            <?php endif; ?>
