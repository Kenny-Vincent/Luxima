...
class codeless_latest_posts extends Widget_Base {
	...
	private function wpcap_content_layout_options() {
		...
		$this->start_controls_section(
			'section_layout',
			[
				'label' => esc_html__( 'Layout', 'specular' ),
			]
		);
		...
		$this->add_control(
			'grid_style',
			[
				'label' => __( 'Grid Style', 'specular' ),
				'type' => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( 'Layout 1', 'specular' ),
					'2' => esc_html__( 'Layout 2', 'specular' ),
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __( 'Posts Per Page', 'specular' ),
		...
		$this->add_control(
			'show_image',
			[
				'label' => __( 'Image', 'specular' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'specular' ),
				'label_off' => __( 'Hide', 'specular' ),
				'default' => 'yes',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'title_tag',
			[
				'label' => __( 'Title HTML Tag', 'specular' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			'meta_data',
			[
				'label' => __( 'Meta Data', 'specular' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT2,
				'default' => [ 'date', 'comments' ],
				'multiple' => true,
				'options' => [
					'author' => __( 'Author', 'specular' ),
					'date' => __( 'Date', 'specular' ),
					'categories' => __( 'Categories', 'specular' ),
					'comments' => __( 'Comments', 'specular' ),
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'meta_separator',
			[
				'label' => __( 'Separator Between', 'specular' ),
		...
		$this->add_control(
			'excerpt_length',
			[
				'label' => __( 'Excerpt Length', 'specular' ),
				'type' => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'read_more_text',
			[
				'label' => __( 'Read More Text', 'specular' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'specular' ),
				'condition' => [
					'show_read_more' => 'yes',
				],
			]
		...
		$this->add_control(
			'content_align',
			[
				'label' => __( 'Alignment', 'specular' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'specular' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'specular' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'specular' ),
	...
	private function wpcap_content_query_options() {
		...
		$this->add_control(
			'orderby',
			[
				'label' => __( 'Order By', 'specular' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_date',
				'options' => [
					'post_date' => __( 'Date', 'specular' ),
					'post_title' => __( 'Title', 'specular' ),
					'rand' => __( 'Random', 'specular' ),
				],
			]
		);
		...
		$this->add_control(
			'order',
			[
				'label' => __( 'Order', 'specular' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'desc',
				'options' => [
					'asc' => __( 'ASC', 'specular' ),
					'desc' => __( 'DESC', 'specular' ),
				],
			]
		);
	...
	private function wpcap_style_layout_options() {
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Columns margin', 'specular' ),
	...
	private function wpcap_style_box_options() {
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Border Widget', 'specular' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Border Radius', 'specular' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => 0,
				],
		...
		$this->add_control(
			...
			[
				...
				'label'     => __( 'Background Color', 'specular' ),
				'scheme'    => [
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Border Color', 'specular' ),
				'scheme'    => [
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
				],
	...
	protected function render_meta() {
		...
		<div class="post-grid-meta">
			...
			if ( in_array( 'categories', $meta_data ) ) {
				...
				$categories_list = get_the_category_list( esc_html__( ', ', 'specular' ) ); 
